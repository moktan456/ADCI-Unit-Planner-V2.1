    ...
    <div className="min-h-screen bg-slate-50 flex overflow-hidden font-sans text-slate-900">
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shrink-0 z-20">
        <div className="p-6 border-b border-slate-100">
          <div className="mb-6 flex items-center gap-2"><Shield className="w-6 h-6 text-primary" /><span className="font-extrabold text-xl tracking-tight text-primary leading-tight">ADCI Unit Planner</span></div>
